    ...
    def test(self, r2v_dataloader, prefix_to_save=None):
        with torch.no_grad():
            ...
            for sample in r2v_dataloader:
                ...
                dice, iou, precision, recall, specificity = self.metric(
                    final_prediction, vessels)
            ...
            avg_dice = total_dice / len(r2v_dataloader)
            avg_iou = total_iou / len(r2v_dataloader)
            avg_precision = total_precision / len(r2v_dataloader)
            avg_recall = total_recall / len(r2v_dataloader)
            avg_specificity = total_specificity / len(r2v_dataloader)
